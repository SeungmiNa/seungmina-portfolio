...
3. **Add** the records Vercel gave you:
   - For **apex (seungmina.com):** add the **A** record(s) Vercel lists (Name `@`, Value the IP(s) they show).
...
- Visit **https://seungmina.com** (and **https://www.seungmina.com**) to confirm the site loads from Vercel.
