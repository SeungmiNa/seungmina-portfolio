            ...
            <div className="relative py-24">
                <div className="max-w-7xl mx-auto px-4">
                    <div className="max-w-3xl mx-auto text-center">
                        ...
                        <Title variant="h1" className="text-5xl md:text-7xl font-bold text-gray-900 mb-8">
                            Brand Guidelines
                        </Title>
            ...
            <div className="max-w-7xl mx-auto px-4 pb-24">
                    ...
                    <div className="flex flex-col justify-center gap-5">
                        ...
                        <div className="p-8 bg-white/60 rounded-xl">
                            ...
                            <div className="flex gap-3 items-center max-w-sm">
                                <div className="w-24 h-24 aspect-square bg-white rounded-2xl shadow-md flex items-center justify-center p-6 hover:shadow-lg transition-shadow">
                                    <InizioSymbolLogo />
                                </div>
                                <div className="w-24 h-24 aspect-square bg-[#0DB9B9] rounded-2xl shadow-md flex items-center justify-center p-6 hover:shadow-lg transition-shadow">
                                    <InizioSymbolLogo variant="white" />
                                </div>
                                <div className="w-24 h-24 aspect-square bg-[#212121] rounded-2xl shadow-md flex items-center justify-center p-6 hover:shadow-lg transition-shadow">
                                    <InizioSymbolLogo />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="p-8 bg-white/60 rounded-xl border border-gray-100 shadow-sm">
                            ...
                            <div className="w-full">
                                <div className="w-full pb-6">
                                    <p className="text-gray-500 text-sm mb-4">Symbol Logo</p>
                            ...
                            <div className="space-y-8  flex flex-col">
                                ...
                                <div className="space-y-6">
                                    <div>
                                        ...
                                        <p className="text-4xl font-bold font-ubuntu">Ubuntu</p>
                                    </div>
                                    <div className="grid grid-cols-3 gap-8 font-ubuntu">
                                        <div>
                                            <p className="text-6xl mb-1">Aa</p>
                                            <p>Regular</p>
                                        </div>
                                        <div>
                                            <p className="text-6xl font-medium mb-1">Aa</p>
                                            <p>Medium</p>
                                        </div>
                                        <div>
                                            <p className="text-6xl font-bold mb-1">Aa</p>
                                            <p>Bold</p>
                                        </div>
                                    </div>
                                    <div className="text-sm leading-relaxed font-ubuntu">
                                ...
                                <div className="space-y-8 pt-8 border-t border-white/20">
                                    <div>
                                        ...
                                        <p className="text-4xl font-bold">Open Sans</p>
                                    </div>
                ...
                <div className="overflow-hidden bg-gradient-to-b from-[#EEEEEE] via-[#0DB9B9]/20 to-white/0">
                    <div className="py-20 text-center">
                        <Title variant="h2" className="text-4xl md:text-5xl font-bold mb-6">Design System</Title>
