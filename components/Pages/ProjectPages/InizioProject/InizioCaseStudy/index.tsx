                    ...
                    <div className="overflow-auto py-3 grid grid-cols-1 md:grid-cols-2 gap-8 items-start max-w-6xl mx-auto w-full">
                        ...
                        <div className="relative w-full h-full aspect-square rounded-3xl overflow-hidden border border-gray-300">
                            ...
                            <div className="absolute bottom-6 left-6 right-6 bg-gray-800/50 backdrop-blur-sm rounded-xl py-3 px-4">
                                <p className="text-sm font-medium text-white pb-1">Original Design</p>
                        ...
                        <div className="space-y-4 p-4">
                            {/* Title Section */}
                            <div className="mb-8">
                                <div className="text-[#5465FF] text-base mb-2">Problem</div>
            ...
            content: (
                <div className="w-full h-full flex flex-col justify-center px-8 py-12 bg-white/60 rounded-xl border border-gray-100">
                    <div className="max-w-6xl mx-auto w-full">
                        {/* Header Section */}
                        <div className="mb-8">
                            <div className="text-[#5465FF] text-base mb-2">Design Challenge</div>
                            <h2 className="text-4xl font-bold mb-4 text-gray-900">
                        ...
                        <div className="flex flex-col md:flex-row gap-4">
                            ...
                            <div className="w-full md:w-1/3 bg-gray-100 rounded-2xl p-8 shadow-sm border border-gray-200">
                                ...
                                <ul className="space-y-2">
                                    {[
                                        ...
                                        <li key={index} className="flex items-start gap-3">
                                            <svg className="mt-0.5 w-5 h-5 text-red-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            {/* Right Column */}
                            <div className="h-full w-full md:w-2/3 bg-white rounded-2xl p-8 shadow-sm border border-gray-200">
                                <h3 className="text-xl font-semibold mb-5 text-gray-900"> Challenge</h3>
                                <p className="text-gray-800 text-base">
                                    Users may want to adjust when they receive generated project ideas—such as a Problem Statement, Mission, Vision, or Goals.
                                </p>
                                ...
                                <div className="mt-4 space-y-6">
                                    <div>
                                        ...
                                        <p className="text-gray-600 pl-8">
                                            From keyword replacements to complete rephrasing and attribute modifications
        ...
        },
        {
            ...
            content: (
                <div className="w-full h-full flex flex-col justify-center px-8 py-12 bg-white/60 rounded-xl border border-gray-100">
                    ...
                    <div className="flex flex-col md:flex-row gap-8 max-w-6xl mx-auto w-full h-[calc(100%-160px)]">
                        ...
                        <div className="w-full md:w-2/5 overflow-y-auto pr-4 space-y-6 max-h-[600px]">
    ...
    return (
        <div className="space-y-8 py-12">
            <div className="text-center max-w-4xl mx-auto px-4">
                <Title variant="h1" className="text-4xl md:text-5xl font-bold to-gray-700 mb-6">
                    Explore the Design Case Study
                </Title>
                <p className="text-gray-600 text-lg">
                    Discover how we transformed user feedback into meaningful design solutions
                </p>
            </div>
                ...
                <Carousel
                    ...
                    prevArrow={({ handlePrev }) => (
                        <IconButton
                            ...
                            size="lg"
                            onClick={handlePrev}
                            className="!absolute top-1/2 left-4 -translate-y-1/2 bg-white/90 hover:bg-white shadow-lg hover:shadow-xl transition-all duration-300"
                        >
                            <svg
                    ...
                    nextArrow={({ handleNext }) => (
                        <IconButton
                            ...
                            size="lg"
                            onClick={handleNext}
                            className="!absolute top-1/2 right-4 -translate-y-1/2 bg-white/90 hover:bg-white shadow-lg hover:shadow-xl transition-all duration-300"
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                fill="none"
