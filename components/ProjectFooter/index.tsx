                    ...
                    <Link href={`/project/${previousProject?.slug}`} className="group">
                        <div className="flex items-center gap-2">
                            ...
                            <div className="flex flex-col">
                                ...
                                <p className="text-base font-semibold text-stone-600 group-hover:text-stone-900">{previousProject?.title}Title</p>
                            </div>
                        </div>
                    </Link>
                    {/* ) : (
                    ...
                    <Link href={`/project/${nextProject?.slug}`} className="group">
                        <div className="flex items-center gap-2">
                            <div className="flex flex-col">
                                ...
                                <p className="text-base font-semibold text-stone-600 group-hover:text-stone-900">{nextProject?.title}Title</p>
                            </div>
